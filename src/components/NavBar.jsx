...
// Simulamos los "tokens" de colores directamente aquí para que no de error
const t = {
...
export default function Navbar() {
  ...
  // Simulamos que siempre es producción para que se vea el menú completo
  ...
  return (
    ...
    >
      {/* Left – Selector de idioma en lugar del rol de debug */}
      ...
      {/* Center – Logo en texto  */}
      <div style={{ display: "flex", justifyContent: "center" }}>
        <img 
          src={calblayIcon} 
          alt="Cal Blay" 
          style={{ 
            height: "50px", /* Ajusta este valor si lo ves muy grande/pequeño */
            objectFit: "contain",
            cursor: "pointer"
          }} 
          onClick={() => navigate("/")}
